...
namespace MapParse.Types
{
    public class Vec3
    {
        ...
        public double Dot(Vec3 v3) { return (X * v3.X) + (Y * v3.Y) + (Z * v3.Z); }

        public static double Dot(Vec3 a, Vec3 b) { return a.Dot(b); }
        ...
        public static Vec3 operator -(Vec3 a, Vec3 b) { return new Vec3(a.X - b.X, a.Y - b.Y, a.Z - b.Z); }
        public static Vec3 operator -(Vec3 a) { return new Vec3() - a; }

        public static Vec3 operator *(Vec3 a, float b) { return new Vec3(a.X * b, a.Y * b, a.Z * b); }
        public static Vec3 operator *(float a, Vec3 b) { return b * a; }
        ...
        public static Vec3 operator *(double a, Vec3 b) { return b * a; }
        public static Vec3 operator *(Vec3 a, int b) { return new Vec3(a.X * b, a.Y * b, a.Z * b); }
